...
const funTypes = [
  "Citizen journalism", "Whistleblower influence", "Fake news", "Escape rooms",
...
const News = () => {
  ...
  return (
    <div className="text-white">
      {/* Dropdown */}
      <div className="mb-6">
        <p className="mb-3 text-lg font-medium">Which type of “News” content do you want to create?</p>
