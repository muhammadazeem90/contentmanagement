...
const funTypes = [
  "Robo-advising", "Geopolitical impacts", "Index funds", "Escape rooms",
...
const Investment = () => {
  ...
  return (
    <div className="text-white">
      {/* Dropdown */}
      <div className="mb-6">
        <p className="mb-3 text-lg font-medium">Which type of “Investment” content do you want to create?</p>
