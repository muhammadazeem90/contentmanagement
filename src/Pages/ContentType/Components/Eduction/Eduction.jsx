...
const funTypes = [
    "Gamified learning", "Education systems", "Bilingual benefits", "Escape rooms",
...
const Eduction = () => {
    ...
    return (
        <div className="text-white">
            {/* Dropdown */}
            <div className="mb-6">
                <p className="mb-3 text-lg font-medium">Which type of “Eduction” content do you want to create?</p>
