...
const funTypes = [
  "Sports medicine", "Team sociology", "Olympic economics", "Escape rooms",
...
const Sports = () => {
  ...
  return (
    <div className="text-white">
      {/* Dropdown */}
      <div className="mb-6">
        <p className="mb-3 text-lg font-medium">Which type of “Sports” content do you want to create?</p>
